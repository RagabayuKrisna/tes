...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2021 at 06:34 AM
...
CREATE TABLE `tb_mahasiswa` (
  `mhs_id` int(12) NOT NULL,
  `mhs_nim` int(12) NOT NULL,
  `mhs_nama` varchar(40) NOT NULL,
...
CREATE TABLE `tb_mahasiswa_nilai` (
  `mhs_nilai_id` int(12) NOT NULL,
  `mhs_id` int(12) NOT NULL,
  `mk_id` int(12) NOT NULL,
...
CREATE TABLE `tb_matakuliah` (
  ...
  `mk_sks` int(12) NOT NULL,
  `mk_nama` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `tb_mahasiswa_nilai`
  ...
  ADD KEY `mhs_nilai_id` (`mhs_nilai_id`),
